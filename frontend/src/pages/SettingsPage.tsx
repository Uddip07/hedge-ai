...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 w-full max-w-full min-w-0 font-mono text-xs">
      {/* Header */}
      <div className="rounded-2xl border border-[#1E293B] bg-[#121826] p-6 shadow-xl">
      ...
      <div className="rounded-2xl border border-[#1E293B] bg-[#121826] p-6 shadow-xl space-y-4">
        <h2 className="text-sm font-bold text-slate-200 uppercase tracking-wider flex items-center gap-2 border-b border-[#1E293B] pb-3">
        ...
        {loadingBroker ? (
          ...
          <div className="rounded-xl border border-[#1E293B] bg-slate-900 p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
      ...
      <form onSubmit={handleSave} className="rounded-2xl border border-[#1E293B] bg-[#121826] p-6 shadow-xl space-y-6">
        <h2 className="text-sm font-bold text-slate-200 border-b border-[#1E293B] pb-3 uppercase tracking-wider flex items-center gap-2">
        ...
        <div>
          ...
          <input
            ...
            placeholder="/api"
            className="w-full rounded-xl border border-[#1E293B] bg-slate-900 px-4 py-2.5 text-slate-100 focus:border-cyan-500 focus:outline-none"
          />
        ...
        <div className="flex items-center justify-between border-t border-[#1E293B] pt-4">
          ...
          <select
            ...
            className="rounded-xl border border-[#1E293B] bg-slate-900 px-3.5 py-2 text-slate-100 font-bold"
          >
        ...
        <div className="flex items-center justify-between border-t border-[#1E293B] pt-6">
          ...
          <Button
            ...
            onClick={() => {
              clearLogs();
              localStorage.clear();
              toast.info('Storage Cleared', 'Local storage and cached logs reset.');
            }}
