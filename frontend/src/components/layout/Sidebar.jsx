...
export const Sidebar = ({ collapsed, onToggle }) => {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 z-30 flex h-screen flex-col border-r border-[#162235] bg-[#06080e] transition-all duration-300 ease-in-out ${
        collapsed ? 'w-16' : 'w-64'
      }`}
    >
      {/* Brand Header */}
      <div className="flex h-16 items-center justify-between border-b border-[#162235] px-4 bg-[#090e17]">
        {!collapsed && (
      ...
      {!collapsed && (
        <div className="border-t border-[#162235] p-3.5 text-xs font-mono bg-[#090e17]">
          <div className="flex items-center gap-2 text-slate-300">
            <Zap className="h-3.5 w-3.5 text-emerald-400" />
            <span className="text-xs">Native Windows Engine</span>
          </div>
