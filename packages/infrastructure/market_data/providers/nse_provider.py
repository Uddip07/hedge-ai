"""
NSE Production Market Data Provider Adapter.

Delegates National Stock Exchange (NSE) queries to YahooMarketDataProvider.
"""
...
class NSEMarketDataProvider(MarketDataProvider):
    """
    Production Adapter for NSE Market Data queries delegating to Yahoo Finance provider backend.
    """
